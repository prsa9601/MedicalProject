namespace MedicalProject.Infrastructure.Extensions
{
    public static class EnumerableExtensions
    {
        ...
        //public static int SafeSumInt<T>(this IEnumerable<T> source, Func<T, string> selector)
        //{
        //    return source
        //        .Select(item => selector(item))
        //        .Where(priceStr => int.TryParse(priceStr, out _))
        //        .Sum(priceStr => int.Parse(priceStr));
        //}
